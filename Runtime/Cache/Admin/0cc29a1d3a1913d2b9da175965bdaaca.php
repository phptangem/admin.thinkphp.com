...
<?php else: ?>
    <?php echo(date("Y-m-d H:i:s")); endif; ?>" <?php echo ((isset($form["extra"]["attr"]) && ($form["extra"]["attr"] !== ""))?($form["extra"]["attr"]):''); ?>>
            ...
            <script type="text/javascript">
                $(function(){
                    var uploader_<?php echo ((isset($group_k) && ($group_k !== ""))?($group_k):''); ?>_upload_<?php echo ($k); ?> = WebUploader.create({
                        ...
                        swf: 'http://admin.thinkphp.com/Public/libs/lyui/dist/swf/uploader.swf',                                                  // swf文件路径
        ...
        <div class="right">
            ...
            <script type="text/javascript" src="http://admin.thinkphp.com/Public/libs/kindeditor/kindeditor-min.js" charset="utf-8"></script>
            <script type="text/javascript">
                $(function(){
                    KindEditor.ready(function(K) {
                        kindeditor_<?php echo ($k); ?> = K.create('#<?php echo ((isset($group_k) && ($group_k !== ""))?($group_k):''); ?>_kindeditor_<?php echo ($k); ?>', {
                            ...
                            filePostName : 'file',
                            cssPath : [
                                'http://admin.thinkphp.com/Public/libs/lyui/dist/css/cui.min.css',
                                'http://admin.thinkphp.com/Public/libs/kindeditor/plugins/code/prettify.css'
                            ],
                            width : '100%',
                            height : '500px',
                            resizeType: 1,
